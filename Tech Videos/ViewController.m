...
#define kMenuItemsUrl @"http://www.aidin4app.com/api/cp/0/all/%@"
#define kPlayCountUrl @"http://www.aidin4app.com/api/cp/0/1/%@"
...
- (void)viewDidLoad {
    ...
    items = [NSArray arrayWithObjects:[[NSDictionary alloc] initWithObjectsAndKeys: @"Loading...", @"description", nil], nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([[item valueForKey:@"description"] isEqualToString:@"Loading..."]){
...
- (IBAction)share:(id)sender{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.cyberpunklab.com/video?appId=0&videoId=%@", [item valueForKey:@"videoid"]]];
